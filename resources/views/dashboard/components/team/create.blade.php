            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Create Team</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.teams.index') }}">Teams</a>
                                    </li>
                                    <li class="breadcrumb-item active">Create Team
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="createForm" action="{{ route('admin.teams.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="foto">Upload Logo Team
                                                <span style="color: red">*</span>
                                            </label>
