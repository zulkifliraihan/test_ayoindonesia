                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="invoice-repeater" id="editForm" action="{{ route('admin.matchs.report.update', $match->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="skor_home_team" id="skor_home_team" class="form-control" value="{{ $skorHomeTeam }}" />
                                        </div>
                                        <div class="form-group">
                                            <label for="skor_guest_team">Skor Team Tamu ({{ $match->guestteam->nama }})
                                                <span style="color: red">*</span>
                                            </label>
                                            <input type="number" name="skor_guest_team" id="skor_guest_team" class="form-control" value="{{ $skorGuestTeam }}" />
                                        </div>
                                        <div class="form-group">
                                                            ...
                                                            <div class="row d-flex align-items-end">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="player_id[]" id="player_id" class=" form-control">
                                                                            ...
                                                                            @foreach ($players as $item )
                                                                                <option value="{{ $item['id'] }}" {{ $item['id'] == $value['player_id'] ? "selected" : "" }}>{{ $item['nama'] }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="time" class="form-control" name="time_goal[]" value="{{ $value->time_goal }}" id="time_goal" aria-describedby="time_goal" />
                                                                    </div>
                                                                </div>
